...
medicos = [
    ...
    (33333333, 30000014, 'Pedro', 'Perez', '450000', '441000', 'Cordoba', 'doctor2@mail.com'),
    (44444444, 40000015, 'Lucas', 'Suarez', '46000', '48100000', 'Cordoba', 'doctor3@mail.com'),
]
miCursor.executemany("INSERT INTO UsuarioMedico VALUES (?, ?, ?, ?, ?, ?, ?, ?)", medicos)
miCursor.execute("INSERT INTO UsuarioMedico VALUES (55555555, 50000015 , 'Carlos', 'Gonzalez', '42000000', '42100000', 'Cordoba', 'doctor0@mail.com')")
miConexion.commit()
miConexion.close()
